...
void draw() {
  ...
  t.rotateToX(radians(mouseX+10));
  t.rotateToZ(radians(mouseY-20));
  t.moveTo(mouseX,mouseY,100);
  t.fill(color(255,0,0));
  t.stroke(color(0));
  t.strokeWeight(0);
  
  t2.setRadius(30,30,0);
  t2.rotateToX(radians(mouseX+5));
  t2.rotateToZ(radians(mouseX-20));
  t2.moveTo(mouseX,mouseY,100);
...
//rotateY(PI/6);
 ...
 rotateX(radians(mouseX-25));
 rotateY(radians(mouseY-25));
